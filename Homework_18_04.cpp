// 4. На рядках 24, 25 оголошуються перевантаження операторів Input/Output,
//    а в кінці документа записані їх визначення.
...
public:
    ...
    friend ostream& operator << (ostream &out, const String &s);    // 4. Перевантаження
    friend istream& operator >> (istream &in, String &s);           //    операторів >> <<
...
{
    return out << s.itsString;
}

istream& operator >> (istream &in, String &s)
{
    return in >> s.itsString;
}
